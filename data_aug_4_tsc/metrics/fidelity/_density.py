...
class DENSITY(BaseMetricCalculator):
    """The Density fidelity metric [1]_ [2]_.

    Density counts the number of neighbor
    spheres containing each of the generated samples.
    This work was proposed by [2]_, this implementation is motivated from
    there code in
    ...
    def calculate(
        ...
        Returns
        -------
        density : float, value of the metric.
        """
